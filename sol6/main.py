"""Kaggriculture submission (sol6): shop-demand-sized farm.
Generated by make_main.py from farmlib.py (design-value strategy vector, NOT CEM-tuned).
See sol6/REPORT.md.
"""
...
# ---- baked strategy ---------------------------------------------------------
VEC = [14, 2, 3, 10, 12, 4, 10, 24, 32, 30, 6, 5, 8, 11, 0.5, 0.9, 0.65, 0.25, 27, 0, 9, 3, 4, 15]
